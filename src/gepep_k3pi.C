...
void K3PI::FitSpectrum(TTree *&dataraw, double beame, char* namesfx, double &peak, double &peakerror)
{
   ...
   RooRealVar sigma("sigma","width of gaussian",0.003,0.0025,0.005);
   RooRealVar sigma2("sigma2","width of gaussian",0.0075,0.005,0.010);
...
//}
  ...
  c1->Write();
   ...
   ofstream outf("k3pi",std::ios::app);
